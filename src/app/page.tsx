...
const CAM_DEFAULT_SCALE = 0.5;
const PT_MAX_SCALE = 0.1;
const PT_MIN_SCALE = 0.005;
const PT_DEFAULT_SCALE = 0.011;
            ...
            <div className="flex flex-col h-screen">
                ...
                <div className="flex-grow relative">
                    ...
                    >
                        ...
                        {selectedRec ? (
                            <ModelViewer
                                key={selectedRec[0].name}
                                name={selectedRec[0].name}
                                rec_no={selectedRec[1]}
                                benchmark={selectedRec[0].benchmark}
                            ...
                            <div
                                className={`flex items-center justify-center h-full text-white select-none`}
                            >
